...
openapi-type: arm
tag: package-2020-03-2021-01-preview
...
These settings apply only when `--tag=package-2020-03-2021-01-preview` is specified on the command line.

``` yaml $(tag) == 'package-2020-03-2021-01-preview'
input-file:
